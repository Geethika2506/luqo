      ...
      <div className="container mx-auto">
          ...
          <div className="md:col-span-1">
            ...
            <div className="flex">
              <input 
                ...
                className="px-3 py-2 w-full rounded-l-md text-textPrimary text-sm focus:outline-none"
              />
              <button 
                className="bg-white text-brand px-4 py-2 rounded-r-md font-medium text-sm hover:bg-white/90 transition-colors"
        ...
        <div className="border-t border-white/20 mt-10 pt-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-white/60 text-sm">
            © {new Date().getFullYear()} LUDO. All rights reserved.
          </p>
