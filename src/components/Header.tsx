  ...
  return <header className="w-full absolute top-0 left-0 z-50 px-4 border-b border-zinc-800 py-2 bg-zinc-950">
      <div className="flex justify-between items-center max-w-6xl mx-auto">
        ...
        <div className={cn("flex items-center", isMobile ? "space-x-4" : "space-x-8")}>
          <a href="/how-it-works" aria-label="How It Works" className="text-white/95 text-sm font-medium transition-all font-montserrat hover:text-white py-px px-[6px] mx-[2px] my-0">
            How It Works
          </a>
