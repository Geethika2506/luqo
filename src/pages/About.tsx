      ...
      <main className="flex-grow container mx-auto px-4 py-10">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose prose-lg">
            <p className="mb-4 font-montserrat">LUQO is dedicated to providing accessible shopping experiences for everyone. Our platform connects users with stores that prioritize accessibility and inclusive environments. Luqo is a platform designed to help small businesses in Spain connect with new customers while building a supportive business community. Our mission is simple: to create an ecosystem where local businesses collaborate, share customer bases, and grow together.  How It Works ?  
We make it easy for businesses to attract and engage customers through unique experiences—workshops, tastings, giveaways, and more. These experiences are accessed via QR codes, bringing customers into the Luqo ecosystem where they can discover other local businesses and exciting opportunities. Why Join Luqo? 
...
 Join Luqo today and be part of a smarter, more connected way to grow! add this the about section</p>
